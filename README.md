...
- **Create a workout session (incremental):** Start a new workout session. Accepts partial data (routineId/baseRoutine, date, initial exercises, notes). You can begin with just a routine reference and add exercises/notes later.
